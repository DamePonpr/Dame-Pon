...
const styles = StyleSheet.create({
  ...
  municipalityDecisionButton: { minHeight: 50, borderRadius: 14, paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  municipalityDecisionButtonText: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 13 },
  halfInput: { flex: 1 },
