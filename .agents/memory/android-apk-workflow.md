...
**How to apply:** When changing Expo or React Native versions, run the GitHub Android workflow from a clean checkout and inspect the first failing step before changing app code. Preserve the direct Babel declarations and recheck whether the clipboard patches are still needed after dependency upgrades.